...
final class MywpControllerModuleAddSiteAutoMainGeneral extends MywpControllerAbstractModule {

  static protected $id = 'add_site_auto_main_general';
  ...
  private static function is_current_plugin( $plugin_file_name = false ) {
    ...
    if ( strpos( MYWP_ADD_SITE_AUTO_PLUGIN_BASENAME , $plugin_file_name ) === false ) {
  ...
  public static function plugin_row_meta( $plugin_meta , $plugin_file , $plugin_data , $status ) {
    ...
    $plugin_meta = apply_filters( 'mywp_add_site_auto_plugin_row_meta' , $plugin_meta , $plugin_file , $plugin_data , $status );
  ...
  public static function plugin_action_links( $actions , $plugin_file , $plugin_data , $context ) {
    ...
    $actions = apply_filters( 'mywp_add_site_auto_plugin_action_links' , $actions , $plugin_file , $plugin_data , $context );
  ...
  public static function in_plugin_update_message( $plugin_data , $response ) {
    ...
    printf( __( 'There is a new version of %1$s available. <a href="%2$s" %3$s>View version %4$s details</a>.' ) , $response->new_version , $plugin_info['github'] , '' ,  MYWP_ADD_SITE_AUTO_NAME );
  ...
  public static function admin_print_footer_scripts() {
    ...
    printf( 'tr#%s-update .update-message p { display: none; }' , MYWP_ADD_SITE_AUTO_PLUGIN_DIRNAME );
    printf( 'tr#%s-update .update-message p.show { display: block; }' , MYWP_ADD_SITE_AUTO_PLUGIN_DIRNAME );
...
MywpControllerModuleAddSiteAutoMainGeneral::init();
